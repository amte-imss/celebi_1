...
class Reporte extends MY_Controller
{
    ...
    public function index(){
        $file_name = 'reporte_directorio_' . date('Ymd_his', time());
        $reporte = $this->reporte->obtener_directorio();
        $columnas = array(
            'matricula','nombre','apellido_paterno',
            'apellido_materno','nombre_tipo_actividad','nombre_modalidad',
            'nombre_area_enfoque','nombre_tipo_curso','clave_curso',
            'nombre_curso','nombre_rol','clave_categoria',
            'categoria','clave_delegacional','nombre_delegacion_docente',
            'clave_unidad_docente','nombre_unidad_docente','clave_unidad',
            'nombre_unidad','fecha_registro','nivel_atencion','clave_presupuestal');
        $this->exportar_xls($columnas, $reporte, null, null, $file_name);
    }
...
//        $main_content = $this->load->view('inicio/demo.tpl.php', null, true);
                $this->template->setTitle('Seguimiento de profesores registrados');
