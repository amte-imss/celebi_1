...
<html lang="es">
    <head>
        ...
        <?php // echo js("plugins_cpredie/jquery-steps/jquery.steps.css"); ?>
        <!-- Custom Css -->
    ...
    <body class="theme-indigo">
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a href="" class="bars" style="color:#000;"></a>
                    <!-- <a class="navbar-brand pull-left" href="index.html" style="color:#333;"></a> -->
                </div>
        ...
        <?php echo js("control_escolar/general.js"); ?>
        <!-- Select Plugin Js -->
        ...
        <?php //echo js("plugins_cpredie/sweetalert/sweetalert.min.js"); ?>
        <?php echo js("plugins_cpredie/jquery-validation/jquery.validate.js"); ?>


        <!-- Bootstrap Notify Plugin Js -->
        <?php echo js("plugins_cpredie/bootstrap-notify/bootstrap-notify.js"); ?>
        <!-- Waves Effect Plugin Js -->
        <?php echo js("plugins_cpredie/node-waves/waves.js"); ?>
        <!-- Custom Js -->
        <?php //echo js("template_cpredie/admin.js"); ?>

        <?php echo js("template_cpredie/pages/ui/modals.js"); ?>

        <!-- Demo Js -->
        <?php echo js("template_cpredie/demo.js"); ?>
        <?php echo js("control_escolar/js_export/canvas-datagrid.js"); ?>
