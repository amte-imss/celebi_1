...
<!--<ul class="list-inline pull-right">
    <li>
        <button type="button" onclick="update_insert(this);"   class="btn btn-primary next-step">Guardar y continuar</button>
    </li>
</ul>-->
<?php echo form_close(); ?>
<?php
...
$rtcd = (isset($data['id_regla_tipo_curso'])) ? $data['id_regla_tipo_curso'] : '';
